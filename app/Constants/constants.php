...
if(!defined('COIN')) define('COIN',  'coin');
...
if(!defined('TRAINING')) define('TRAINING' , 'training');
...
if(!defined('UNPAID')) define('UNPAID', 2);
...
if(!defined('POINT_TYPE_SUBSCRIBE_VIDEO')) define('POINT_TYPE_SUBSCRIBE_VIDEO', 1);

if(!defined('POINT_TYPE_LIKE_VIDEO')) define('POINT_TYPE_LIKE_VIDEO', 2);

if(!defined('POINT_TYPE_DISLIKE_VIDEO')) define('POINT_TYPE_DISLIKE_VIDEO', 3);

if(!defined('POINT_TYPE_COMMENT_VIDEO')) define('POINT_TYPE_COMMENT_VIDEO', 4);
if(!defined('POINT_TYPE_TIP_ME')) define('POINT_TYPE_TIP_ME', 5);
if(!defined('POINT_TYPE_TIP_CREDIT')) define('POINT_TYPE_TIP_CREDIT', 6);
if(!defined('POINT_TYPE_PRODUCT_RATING')) define('POINT_TYPE_PRODUCT_RATING', 7);
if(!defined('POINT_TYPE_PRODUCT_COMMENT')) define('POINT_TYPE_PRODUCT_COMMENT', 8);
if(!defined('POINT_TYPE_PRODUCT_IMAGE')) define('POINT_TYPE_PRODUCT_IMAGE', 9);
if(!defined('POINT_TYPE_TOKEN_PURCHASE')) define('POINT_TYPE_TOKEN_PURCHASE', 10);
if(!defined('POINT_TYPE_POINT_USE')) define('POINT_TYPE_POINT_USE', 11);



if(!defined('CHANNEL_TYPE_FREE')) define('CHANNEL_TYPE_FREE', 1);

if(!defined('CHANNEL_TYPE_PAID')) define('CHANNEL_TYPE_PAID', 2);
