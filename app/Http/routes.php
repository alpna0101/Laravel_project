...
Route::group(['prefix' => 'admin' , 'as' => 'admin.'], function(){
    ...
    Route::get('/users/password/{id}', 'AdminController@user_password')->name('users.password');
    ...
    Route::post('/users/password', 'AdminController@users_password')->name('users.password');
    ...
    Route::get('videos/sponsored-status/{id}', 'AdminController@sponsored_status_change')->name('videos.sponsored-status-change');
...
//coin
   ...
   Route::get('/coin_price_update', 'AdminController@coin_price_update')->name('users.coin_price_update');
    ...
    Route::get('/pages/owners', 'AdminController@owners_page')->name('pages.owners');

    Route::post('/pages/owner/save', 'AdminController@owner_save')->name('owner.save');

    Route::get('/pages/owner/status','AdminController@owner_status_change')->name('owner.status');

    Route::get('/pages/owner/delete','AdminController@owner_status_delete')->name('owner.delete');
    ...
    // Products
    Route::get('products','AdminController@productList')->name('products');
    
    Route::get('add-product','AdminController@addProduct');
    Route::post('save-product/{id?}','AdminController@save_product');
    Route::get('update-product/{product_id}','AdminController@editProduct')->name('editProduct');
    Route::post('edit-product','AdminController@addProduct');
    Route::get('delete-product/{id}','AdminController@destroy')->name('delete_product');
    Route::get('customerorders','AdminController@customerorders')->name('customerorders');
    Route::post('save_shipping','AdminController@save_shipping')->name('save_shipping');
    Route::get('view_invoice/{id}','AdminController@view_invoice')->name('view_invoice');
    Route::get('point_create','AdminController@point_create')->name("point_create");
    Route::post('save_point','AdminController@save_point');
    Route::get('point_index','AdminController@point_index')->name('point_index');
    Route::get('point_edit/{id}','AdminController@point_edit')->name('point_edit');
    Route::get('delete_point/{id}','AdminController@delete_point')->name('delete_point');
    ...
    Route::get('chat/',['as' => 'chat', 'uses' => 'AppController@usersChat']);
    Route::get('screenshare/{room}',['as' => 'screenshare', 'uses' => 'AppController@screenShare']);

    Route::get('group/{groupid}',['as' => 'group', 'uses' => 'AppController@groupChat']);
    Route::get('leave_group/{groupid}',['as' => 'leave_group', 'uses' => 'AppController@leave_group']);
    Route::post('save_group/',['as' => 'save_group', 'uses' => 'AppController@save_group']);
    Route::post('update_group/',['as' => 'update_group', 'uses' => 'AppController@update_group']);

   Route::get('get_members/{groupid}' , ['as' => 'get_members', 'uses' => 'AppController@getGroupMembers']);
   Route::get('restuser/{groupid}' , ['as' => 'restuser', 'uses' => 'AppController@restuser']);

    


    Route::post('reasetchatreadby',['as' => 'reasetchatreadby', 'uses' => 'AppController@reasetChatReadBy']);
    Route::post('updateChatReadBy',['as' => 'updateChatReadBy', 'uses' => 'AppController@updateChatReadBy']);
    Route::get('get_ajax_conversation_user',['as' => 'get_ajax_conversation_user', 'uses' => 'AppController@chatUsers']);
    Route::get('get_ajax_groups',['as' => 'get_ajax_groups', 'uses' => 'AppController@getUsersGroup']);
...
Route::group(['as' => 'user.'], function(){
    ...
    Route::get('/training', 'UserController@training')->name('training');
    Route::get('/making-money', 'UserController@makingMoney')->name('making_money');
    Route::get('/topplayer', 'UserController@topplayer')->name('topplayer');
   Route::get('/check_mail', 'UserController@check_mail')->name('check_mail');
    ...
    Route::post('/notify_token', 'AppController@notify_token')->name('notify_token.save');

   
    Route::post('/notify_curl', 'AppController@notify_curl')->name('notify_curl.save');
    Route::post('/gettokens', 'UserController@gettokens')->name('gettokens.save');
    Route::post('/get_notify_token', 'AppController@get_notify_token')->name('get_notify_token.save');
    ...
    Route::post('/profile/btc_save', 'UserController@btc_save')->name('profile.btc_save');
    Route::get('/profile/addbtc', 'UserController@addbtc')->name('profile.addbtc');
    Route::get('/profile/showbtc', 'UserController@btc_show')->name('profile.showbtc');
    Route::get('/profile/editbtc', 'UserController@editbtc')->name('profile.editbtc');
    // Delete Account
    ...
    Route::get('/paypal/{order_id}/','PaypalController@order_pay')->name('order_pay');
    ...
    Route::post('/tip_video', 'UserController@tipVideo')->name('video.tip');
    ...
    Route::get('/coin_payment', 'UserController@coin_payment')->name('card.coin_payment');
    ...
    // Route::get('invoice_new', 'UserController@invoice_new');
...
///products
    ...
    Route::get('/edt_address/{id}', 'ProductController@edt_address')->name('edt_address');
    Route::get('/delete_address/{id}', 'ProductController@delete_address')->name('delete_address');

    Route::get('/marketplace', 'ProductController@marketplace')->name('marketplace');
    ...
    Route::get('/product_preview/{id}', 'ProductController@show')->name('product_preview');
    Route::get('/buy_product/{id}', 'ProductController@buy_product')->name('buy_product');
    Route::get('/add_to_cart/{id}', 'ProductController@add_to_cart')->name('add_to_cart');
    Route::get('/update_cart/{id}/{qtity}', 'ProductController@update_cart')->name('update_cart');
    Route::get('/delete_cart/{id}', 'ProductController@delete_cart')->name('delete_cart');
    Route::get('/view_cart', 'ProductController@view_cart')->name('view_cart');
    Route::get('/add_address', 'ProductController@add_address')->name('add_address');
    Route::get('/myorders', 'ProductController@myorders')->name('myorders');
    Route::get('/customerorders', 'ProductController@customerorders')->name('customerorders');
    Route::post('/save_address', 'ProductController@save_address')->name('save_address');
    Route::get('/checkout', 'ProductController@checkout')->name('checkout');
    Route::get('/create_stripe_customer', 'ProductController@create_stripe_customer')->name('create_stripe_customer');
    
    Route::post('/use_token', 'ProductController@use_token')->name('use_token');
    Route::post('/check_cart_seller', 'ProductController@checkCartOtherSellerProduct')->name('check_cart_seller');
    Route::post('/checkout_order', 'ProductController@checkout_order')->name('checkout_order');
    Route::post('/save_payment_method', 'ProductController@save_payment_method')->name('save_payment_method');
    Route::post('/transaction_update', 'ProductController@transaction_update')->name('transaction_update');
     Route::get('/view_invoice/{id}', 'ProductController@view_invoice')->name('view_invoice');
      Route::post('/payment_send', 'ProductController@payment_send')->name('payment_send');
     Route::get('/mark_paid/{id}', 'ProductController@mark_paid')->name('mark_paid');
      Route::post('/save_shipping', 'ProductController@save_shipping')->name('save_shipping');
      Route::get('/shipping_detail/{id}', 'ProductController@shipping_detail')->name('shipping_detail');
      Route::get('/order_status/{id}/{status}', 'ProductController@order_status')->name('order_status');
      Route::get('/notifications', 'ProductController@notifications')->name('notifications');
      Route::get('/notifications_update', 'ProductController@notifications_update')->name('notifications_update');
      Route::get('/edit_payment_method', 'ProductController@edit_payment_method')->name('edit_payment_method');
      Route::post('/update_payment_method', 'ProductController@update_payment_method')->name('update_payment_method');
      Route::post('/save_rating_comment', 'ProductController@save_rating_comment')->name('save_rating_comment');
      Route::get('/ownerpage', 'ProductController@ownerpage')->name('ownerpage');
      Route::get('/add_to_wishlist/{id}', 'ProductController@add_to_wishlist')->name('add_to_wishlist');
      Route::get('/remove_to_wishlist/{id}', 'ProductController@remove_to_wishlist')->name('remove_to_wishlist');
      

});

Route::get('/user-products','ProductController@user_all_products')->name("user-products");
Route::get('/admin-products','ProductController@admin_all_products')->name("admin-products");
  

Route::group(['prefix' => 'userApi'], function(){

    // Live Urls
    Route::get('/video_points', 'UserApiController@oldvideo_points')->name('video_points');
    ...
    // Route::post('/training' , 'UserApiController@training');
   ...
   // Route::post('/singleVideo' , 'UserApiController@getSingleVideo');
    ...
    Route::post('/tip_me', 'UserApiController@Tipme');
    Route::post('/product_tip', 'UserApiController@product_tip');
...
Route::get('payment_status', 'UserApiController@subsciption_update_payment_status');
Route::get('transaction_status', 'UserApiController@order_payment_status');
Route::get('add_update_coin_market', 'UserApiController@add_update_coin_market');
