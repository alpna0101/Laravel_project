	...
	<div class="row">
		...
		<div class="col-lg-3 col-xs-3">
			...
			<div class="small-box bg-maroon">
				<div class="inner">
					<h3>{{Setting::get('currency')}} {{$total_user_subscription_payments}}</h3>
					<p>{{tr('channel_subscription_payments')}}</p>
				</div>
				...
				<a href="{{ route('admin.user_subscriptions.payments')}}" class="small-box-footer">
					{{tr('more_info')}}
					<i class="fa fa-arrow-circle-right"></i>
				</a>
			</div>
