                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="referral_commission">{{tr('referral_commission') ." (". tr('tier') . " 1)"}}</label>

                                    <input type="text" class="form-control" name="referral_commission" pattern="[0-9]{0,}" value="{{Setting::get('referral_commission')  }}" id="referral_commission" max="100" maxlength="100" placeholder="{{tr('referral_commission')}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="referral_commission2">{{tr('referral_commission') ." (". tr('tier') . " 2)"}}</label>

                                    <input type="text" class="form-control" name="referral_commission2" pattern="[0-9]{0,}" value="{{Setting::get('referral_commission2')  }}" id="referral_commission2" max="100" maxlength="100" placeholder="{{tr('referral_commission')}}">
                                </div>
                            </div>
