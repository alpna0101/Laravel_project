            								...
            								<li class="{{ $i <= 2 ? 'dropdown' : 'dropup' }} ">
								                ...
								                <ul class="dropdown-menu dropdown-menu-right">
								                	...
								                	@else
								                  	...
								                  	<li role="presentation"><a role="menuitem" tabindex="-1" href="{{route('admin.videos.sponsored-status-change',$video->video_tape_id)}}">{{ ($video->isSponsored) ? tr('remove_sponsor') : tr('mark_sponsor')}}</a></li>
