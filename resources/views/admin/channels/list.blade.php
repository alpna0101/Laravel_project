	              	...
	              	<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							@foreach($channels as $i => $channel)
							    ...
							    <tr>
							      	<td>{{$i+1}}</td>
							      	<td><a target="_blank" href="{{route('admin.channels.view', $channel->id)}}">{{$channel->name}}</a>
            							...
            							<ul class="admin-action btn btn-default">
            								...
            								<li class="{{$i <=2 ? 'dropdown' : 'dropup'}}">
								                ...
								                <ul class="dropdown-menu">
													...
													<li role="presentation">
														<a role="menuitem" tabindex="-1" href="{{route('admin.user_subscriptions.index' , ['channel_id' => $channel->id])}}">{{tr('subscriptions')}}
														</a>
													</li>
