        ...
        <div class="box box-primary">
            ...
            <form class="form-horizontal" action="{{route('admin.channels.save')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">{{tr('channel_type')}} *</label>
                        <div class="col-sm-10">
                            <input type="radio" name="channel_type" value="{{CHANNEL_TYPE_FREE}}" class="iCheck" @if($channel->channel_type == CHANNEL_TYPE_FREE) checked @endif> {{tr('free_channel')}}
                        
                        <input type="radio" name="channel_type" value="{{CHANNEL_TYPE_PAID}}" class="iCheck" @if($channel->channel_type == CHANNEL_TYPE_PAID) checked @endif> {{tr('paid_channel')}}
                        </div>
                    </div>
