        ...
        <div class="box box-primary">
            ...
            <form class="form-horizontal" action="{{route('admin.subscriptions.save')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="amount" class="">{{tr('aru_token')}}</label>

                        <!-- <div class="col-sm-10"> -->
                            <input type="text" required name="gift_token" class="form-control" id="amount" placeholder="{{tr('aru_token')}}" step="any" value="{{($data->gift_token) ? $data->gift_token : old('gift_token')}}"  maxlength="5">
                        <!-- </div> -->
                    </div>
