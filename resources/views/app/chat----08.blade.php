                        ...
                        @if(@$chat && $chat->type === 'user')
                          ...
                          @else
                           @if($chat)
                            ...
                            <ul class="caht_optn_list">
                            <li><a href="#" onclick="start(event)"><img src="{{asset('video_calling.png')}}"></a></li>
								<li><span class="view_user_icon" data-toggle="modal" data-target="#screenshare_link" title="Share Screen"><img src="{{asset('screen_share.png')}}"></span></li>
...
if(roomidget==""){
 ...
 roomid  = getRoomId()
  videurl = window.location.href+"?id="+roomid
}else{
  roomid = roomidget
}
  if(roomidget!=""){
...
$(document).ready(function(){
 ...
 <script src="{{ asset('js/notify.min.js') }}"></script>
  ...
  html: "<div><img src='https://www.cjclive.com/uploads/images/afff0074db2f4ad1dcd11d82e0cc214d247914cc.png' style='width:30px;margin-right:5px;'><span data-notify-text/></div><br>",
  classes: {
    base: {
