                                ...
                                <div class="editform-content"> 
                                    <form  action="{{ route('user.profile.save') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{old('wallet_address') ?: Auth::user()->wallet_address}}" name="wallet_address" class="form-control" placeholder="{{tr('wallet_address')}}" id="wallet_address">
                                        </div>

                                        <div class="form-group">
                                            <label for="coin_payment_pay_name">{{tr('coin_payment_pay_name')}}</label>
                                            <input type="text" value="{{old('coin_payment_pay_name') ?: Auth::user()->coin_payment_pay_name}}" name="coin_payment_pay_name" class="form-control" placeholder="{{tr('coin_payment_pay_name')}}" id="coin_payment_pay_name">
                                        </div>
