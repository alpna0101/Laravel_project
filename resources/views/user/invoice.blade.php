								...
								<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 white-bg">
									<div class="spacing1">
										...
										<form method="post" action="{{route('user.subscription.payment')}}">
											...
											<div>
											    <label class="radio1">
												    <input id="radio3" type="radio" name="payment_type" value="3">
										  ...
										  <div class="modal-dialog">
										    ...
										    <div class="modal-content">
										      ...
										      <div class="modal-body">
										        <p>Once your payment will complete you will be notify through email.</p>
										        <p>click on proceed to pay</p> 
										      </div>
											...
											<div id= "pay_now" class="btn btn-danger">{{tr('pay_now')}}</div>
												<!-- <button id="my_button" class="btn btn-danger">
