...
<h1 class="st_channel_heading text-uppercase">{{$channel->name}} 

    @if($channel->channel_type == CHANNEL_TYPE_PAID)

    <img src="{{asset('images/correct.png')}}" width="8%" height="8%">
...
<li role="presentation" >
    <a href="{{route('user.user_subscriptions.index', ['channel_id' => $channel->id])}}" class="yt-uix-button spf-link  yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default">

    <span class="yt-uix-button-content hidden-xs">{{tr('subscriptions')}}</span> 

    <span class="visible-xs"><i class="fa fa-money channel-tab-icon"></i> &nbsp;</span>
    </a>
</li>
...
<li role="presentation" >
    <a href="{{route('user.user_subscriptions.index', ['channel_id' => $channel->id, 'type' => 'subscribe'])}}" class="yt-uix-button spf-link  yt-uix-sessionlink yt-uix-button-epic-nav-item yt-uix-button-size-default">
