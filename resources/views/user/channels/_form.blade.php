			...
			<div class="slide-area recom-area abt-sec des-crt">
				<div class="abt-sec-head description-create">
					...
					<div class="des-box">
						...
						<h5>* {{tr('choose_channel_type')}}</h5>

                        <input type="radio" name="channel_type" value="{{CHANNEL_TYPE_FREE}}" class="iCheck" @if($model->channel_type == CHANNEL_TYPE_FREE) checked @endif> {{tr('free_channel')}}
                        
                        <input type="radio" name="channel_type" value="{{CHANNEL_TYPE_PAID}}" class="iCheck" @if($model->channel_type == CHANNEL_TYPE_PAID) checked @endif> {{tr('paid_channel')}}
