                                  ...
                                  <div class="row">
                                   ...
                                   <!--      <label for="video" class="control-label">{{tr('sub_title')}}</label>
                                    ...
                                    <div class="clearfix"></div>
                                     ...
                                     <div class="col-lg-12">
                                        <label for="name" class="control-label">{{tr('banner_title')}} </label>
                                        <div>
                                            <input type="text"  class="form-control" id="title" name="banner_title" placeholder="{{tr('banner_title')}}">
                                        </div>
                                    </div>
                                      <div class="col-lg-12">
                                        <label for="name" class="control-label">{{tr('banner_description')}}</label>
                                        <div>
                                              <textarea placeholder="{{tr('banner_description')}}" rows="3"  class="form-control" id="banner_description" name="banner_description" ></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="clearfix"></div>
                                      ...
                                      <div class="col-lg-12">
                                          ...
                                          <div class="pull-right">  
                                              ...
                                              <input type='button' class='btn btn-fill btn-danger btn-wd' name='next' value='Next' id ="description" onclick="countNext('description')" />
...
<script>
  $(document).ready(function(){
     var res = "";
    $("#other_video").change(function(){
      var str = $(this).val();
       res = str.match(/www.youtube.com/g);
       
       if(res!=null){
      
        alert("You can not use youtube video link.")

        $('#manual_finish').attr('disabled',true);
        
        return false;
       }else{
        $('#manual_finish').attr('disabled', false);
       }
    })
  })
     $("#abort_btn").hide();
