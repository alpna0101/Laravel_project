...
<!-- 
 ...
 <div class="clearfix"></div>
                                        ...
                                        <div>
                                            <input type="text"  class="form-control" id="title" name="banner_title" value="{{$model->banner_title}}" placeholder="{{tr('banner_title')}}">
                                        </div>
                                    </div>
                                      <div class="col-lg-12">
                                        <label for="name" class="control-label">{{tr('banner_description')}} * </label>
                                        <div>
                                              <textarea placeholder="{{tr('banner_description')}}" rows="3"  class="form-control" id="banner_description" name="banner_description" >{{$model->banner_description}}</textarea>
                                        </div>
                                        </div>
